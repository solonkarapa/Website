...
- Proposition B is: $\frac{(s/12 - 4)}{12} - 4 = 1$ gives us $s=708$. From steps 2-4  this implies that $x=54$, which is outside the range given in step 1. So this is not a valid solution. 
