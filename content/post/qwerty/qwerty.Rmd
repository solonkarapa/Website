...
Crucially, this calculation is based on the assumption that the designer had chosen in advance to place 10 letters at the top row[^1].
...
Overall, adding more letters at the top row increases the probability substantially. For example, the probability increases by 750% when going from $K=10$ to $16$ letters. Nevertheless, in absolute terms even for $K =19$ it is so small that we can conclude it is unlikely that these letters would appear together by chance. 
