...
Then, we are asked: "If Gus goes first what are his chances of being bought a drink?" This is the chance that Gus wins - the probability that he rolls his favourite score. 

Should be the same 1/18.

We don't know if his favourite score is 3 or 11, but we know the probability of rolling either 3 or 11 is equal to the sum of the probability of rolling  3 and the probability of rolling 11, that is[^2] 


$$P(3 \text{ or } 11) = P(3) + P(11) $$
and we know that $P(3) = P(11)= 1/18$. So the probability Gus wins is $2/18 = 1/9$. 

[^2]: This is usually called the addition rule. It states that for two events A and B, the probability that either one or both events occur is P(A or B) = P(A) + P(B) - P(A and B). The last term, P(A and B), is the probability that both events occur. In our case, it is zero because we cannot have a score of 3 and 11 at the same time, they cannot occur together when rolling a pair of dice. 
