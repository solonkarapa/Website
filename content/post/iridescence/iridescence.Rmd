...
Effectively this analyses ignores the competing risks. A *competing risk* is an event whose occurrence precludes the occurrence of the primary event of interest. Being eaten by other animals precludes to be eaten by birds! 
...
To reiterate, the difference between the two hazard function is in the risk set. For the cause-specific hazard, the risk set decreases at each time point at which there is a failure of another cause. For subdistribution hazard insects who fail from another cause remain in the risk set.

Here, I'm interested in modelling the effect of covariates on both hazards and see if that leads to different conclusions. 
