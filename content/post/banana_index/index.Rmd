...
Again, beef is the most variable. For example, a beef steak has a banana index of 148.6 when emissions are measured by weight and only 8.3 when measured by protein content. 
...
Following the same approach for land use, we still find beef to be the most variable but most foods show decreased variability in their banana index. This indicates the banana index for land use is robust to the metric used. 
