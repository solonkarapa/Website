...
Following the same approach for land use, we still find beef to be the most variable, but most foods show decreased variability in their banana index. This indicates the land required to produce these foods, by weight or nutritional content, does not change a lot.
...
Lastly, I look at the relationship between emissions and land use. The banana index for land use is plotted against the index for emissions. This is done by weight (top-left), calories (top-right) and protein content (bottom). Foods falling into the diagonal dashed line have the same banana index for both emissions and land use. The blue lines corresponds to the "average" relationship across all the foods. 
