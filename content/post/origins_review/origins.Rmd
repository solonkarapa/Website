...
header:
  caption: ''
  image: ''
bibliography: biblio_origins.bib  
draft: TRUE
---
...
What is the connecting link between the voting patterns in south-eastern US states and an ocean formed millions of years ago? The Earth's rotation and the build Taj Mahal? How the formation of coal deposits 300 million years ago influence the political map of today's Britain?
...
The book advocates in favour of nuclear power as it solves the problem of relying on natural elements (sun, wind, river). In addition, nuclear power produces small amounts of carbon dioxide ([The Economist, 2022](https://www.economist.com/briefing/2022/06/23/energy-security-gives-climate-friendly-nuclear-power-plants-a-new-appeal)), it is safe ([Hannah Ritchie, 2020](https://ourworldindata.org/safest-sources-of-energy)) and, most importantly, it occupies the least space among other energy sources ([Hannah Ritchie, 2022](https://ourworldindata.org/land-use-per-energy-source?utm_source=OWID+Newsletter&utm_campaign=39d2bf489c-biweekly-digest-2022-06-17&utm_medium=email&utm_term=0_2e166c1fc1-39d2bf489c-536929022)).       

Hence, nuclear-power plants seem to be promising. But, first, we need to get them easier to build ([The Economist, 2022](https://www.economist.com/briefing/2022/06/23/energy-security-gives-climate-friendly-nuclear-power-plants-a-new-appeal)). 
